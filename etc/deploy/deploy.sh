...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" search-indexer-internal-web/target/search-internal-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/search-internal.war
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" target/search-*solr_core.tar.gz deploy@estadisticas.arte.internal:$TRANSFER_PATH/search-solr_core.tar.gz
