...
public class ServiceExceptionUtils {
    ...
    public static MetamacException manageSrmInternalRestException(Exception e, Object clientProxy) throws MetamacException {
        return manageMetamacRestException(e, ServiceExceptionParameters.API_SRM_INTERNAL, clientProxy);
    }
