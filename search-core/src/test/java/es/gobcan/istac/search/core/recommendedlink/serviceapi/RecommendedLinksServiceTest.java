...
@Ignore
public class RecommendedLinksServiceTest /* extends AbstractDbUnitJpaTests */ implements RecommendedLinksServiceTestBase {
    //
    // @Autowired
    // protected RecommendedLinksService recommendedLinksService;

    @Override
    @Test
    public void testFindRecommendedLinkById() throws Exception {
        fail("testFindRecommendedLinkById not implemented");
    }
    ...
    @Override
    @Test
    public void testFindRecommendedLinksByCondition() throws Exception {
        fail("testFindRecommendedLinksByCondition not implemented");
    }
