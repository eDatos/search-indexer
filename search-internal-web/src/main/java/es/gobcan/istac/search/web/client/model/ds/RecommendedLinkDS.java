...
public class RecommendedLinkDS extends DataSource {

    public static final String URL                          = "recommendedlink-url";
    ...
    public static final String RECOMMENDED_KEYWORD_NAME     = "recommendedlink-recommendedkeyword-name";

    public static final String RECOMMENDED_LINK_DTO         = "recommendedlink-dto";
